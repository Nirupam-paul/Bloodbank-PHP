    ...
    <footer id="footer-1" class="bg-image wide-40 footer division">
        <div class="container">
            ...
            <div class="row">	
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="footer-info mb-40">
                        <img src="images/images-footer-logo-white.png" width="180" height="40" alt="footer-logo">
                ...
                <div class="col-md-6 col-lg-3">
                    <div class="footer-box mb-40">
                        ...
                        <!-- Text -->	
                        <p class="p-sm mt-15">
                            Aliquam orci nullam undo tempor sapien gravida donec enim ipsum porta
            ...
            <div class="bottom-footer">
                <div class="row">
                    <div class="col-md-12">
                        <p class="footer-copyright text-center">&copy; 2019 <span>MedService</span>. All Rights Reserved</p>
                    </div>
                </div>
            </div>
        </div>	   <!-- End container -->										

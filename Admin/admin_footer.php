<footer id="footer-1" class="wide-40 footer division">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-3">
                <div class="footer-info mb-40">
                    <img src="images/logo.png" width="180" height="40" alt="footer-logo">
                    <p class="p-sm mt-20">“To give blood you need neither extra strength nor extra food, and you will save a life.”
                    </p>
                    <!-- Social Icons -->
            ...
            <div class="col-md-6 col-lg-3">
                <div class="footer-box mb-40">
                    ...
                    <!-- Address -->
                    <p>Hatkhuapara,Azara</p>
                    <p>Guwahati,Pin:781017</p>

                    <!-- Email -->
                    <p class="foo-email mt-10">Email:<br />
                        <a href="mailto:zahidmansur32@gmail.com">zahidmansur32@gmail.com</a></br>
                        <a href="mailto:tridipkalita100@gmail.com">tridipkalita100@gmail.com</a></br>
                        <a href="mailto:nirupam17paul@gmail.com">nirupam17paul@gmail.com</a>
                    </p>
                    <!-- Phone -->
        ...
        <div class="bottom-footer">
            <div class="row">
                <div class="col-md-12">
                    <p class="footer-copyright text-center">&copy; 2019 <span>LIVE SAVER</span>. All Rights Reserved</p>
                </div>
            </div>
        </div>
    </div> <!-- End container -->
